...
// By default, the test program enables all the optional features by defining the suitable macros, so it can test them. However, if the macro ` THREAD_POOL_LIGHT_TEST` is defined during compilation, the optional features will not be tested, and in addition, exception handling will be disabled.
#ifndef THREAD_POOL_LIGHT_TEST
...
#define THREAD_POOL_TEST_VERSION_MAJOR 4
#define THREAD_POOL_TEST_VERSION_MINOR 1
#define THREAD_POOL_TEST_VERSION_PATCH 0

#if (THREAD_POOL_TEST_VERSION_MAJOR != THREAD_POOL_VERSION_MAJOR || THREAD_POOL_TEST_VERSION_MINOR != THREAD_POOL_VERSION_MINOR ||  THREAD_POOL_TEST_VERSION_PATCH !=  THREAD_POOL_VERSION_PATCH)
    #error The versions of  thread_pool_test.cpp and  thread_pool.hpp do not match. Aborting compilation.
#endif

#if (THREAD_POOL_TEST_VERSION_MAJOR != THREAD_POOL_UTILS_VERSION_MAJOR || THREAD_POOL_TEST_VERSION_MINOR != THREAD_POOL_UTILS_VERSION_MINOR ||  THREAD_POOL_TEST_VERSION_PATCH !=  THREAD_POOL_UTILS_VERSION_PATCH)
    #error The versions of  thread_pool_test.cpp and  thread_pool_utils.hpp do not match. Aborting compilation.
#endif
...
void show_intro()
{
    ...
    dual_println("Thread pool library version is ",  THREAD_POOL_VERSION_MAJOR, '.',  THREAD_POOL_VERSION_MINOR, '.',  THREAD_POOL_VERSION_PATCH, '.');
    dual_println("Thread pool utilities library version is ",  THREAD_POOL_UTILS_VERSION_MAJOR, '.',  THREAD_POOL_UTILS_VERSION_MINOR, '.',  THREAD_POOL_UTILS_VERSION_PATCH, '.');
...
#if defined(__APPLE__) && !defined( THREAD_POOL_DISABLE_EXCEPTION_HANDLING)
