...
/* rnx2rtkp entry -------------------------------------------------------------*/
extern int rtkentry(int argc, char **argv) //[command]: rnx2rtkp -k rtkopts.conf rover.24o base.24o rover.24n -o GnssRtkResult.txt
{
    fprintf(stderr,"[INFO]:  GNSS-RTK Start Computing...\n");
